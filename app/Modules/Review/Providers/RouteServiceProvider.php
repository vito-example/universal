...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'App\Modules\Review\Http\Controllers';
    ...
    protected function mapWebRoutes()
    {
        ...
        Route::group([
            ...
            require module_path('review', 'Routes/web.php', 'app');
        });
    }
    ...
    protected function mapApiRoutes()
    {
        Route::group([
            ...
            require module_path('review', 'Routes/api.php', 'app');
        });
    }
    ...
    protected function mapAdminRoutes()
    {
        Route::group([
            ...
            require module_path('review', 'Routes/admin.php', 'app');
        });
    }
}
