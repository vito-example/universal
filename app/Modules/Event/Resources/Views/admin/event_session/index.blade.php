                ...
                <div class="table-responsive">
                    <table class="table table-vcenter table-striped">
                        ...
                        <tr>
                            ...
                            <th> {{ $trans_text['register_persons'] }}</th>
                        ...
                        @foreach($allData as $item)
                            <tr>
                                ...
                                <td>{!! $item->register_personCount !!}</td>
                                <td>
                                    <event-session-status-update
                                        event-session-status="{{ $item->status_label }}"
                                        :url="'{{ route($baseRouteName . 'update_session_status_data') }}'"
                                        :id="{{ $item->id }}"
                                        :status="{{$item->status}}"
                                    >
                                    </event-session-status-update>
