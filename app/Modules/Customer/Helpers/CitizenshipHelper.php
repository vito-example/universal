...
class CitizenshipHelper
{
     ...
     * @return array
     */
    public static function getRoutes($baseRouteName = 'admin', $baseModuleName = 'citizenship')
    {
     ...
     * @return array
     */
    public static function getLang($baseLangName = 'admin', $baseModuleName = 'citizenship')
    {
        ...
        $langData = [
            ...
            'country_code' => __($baseFullLangName . 'country_code'),
        ];
