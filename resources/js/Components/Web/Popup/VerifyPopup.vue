    ...
    >
        ...
        <form @submit.prevent="submit">
            <div class="mt-4 flex items-center justify-between">
                ...
                <inertia-link :href="route('logout')" method="post" as="button" class="button button--primary button--shadow button--border width-full margin-left-16 margin-top-24">
                        {{ __('Log out') }}
                </inertia-link>
            </div>
        </form>
...
export default {
    ...
    created() {
        this.visible = this.$page.props.verifyModal;
    },
    computed: {
    ...
    mounted() {
        emitter.on('showVerifyPopup', () => this.visible = true)
    }
}
</script>
