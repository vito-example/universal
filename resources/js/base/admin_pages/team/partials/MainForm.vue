                            ...
                            <div class="row">
                                ...
                                <div class="form-group dashed">
                                    <label class="col-md-1 control-label"><span
                                        class="text-danger">*</span>{{ lang.name }} <span class="grey">{{
                                            locale
                                        }}</span>:</label>
                                ...
                                <div class="form-group dashed">
                                    <label class="col-md-1 control-label"><span
                                        class="text-danger">*</span>{{ lang.position }} <span class="grey">{{
                                            locale
                                        }}</span>:</label>
                                    <div class="col-md-10 uppercase-medium">
                                        <input class="form-control" maxlength="150"
                                ...
                                <div class="form-group editor-large">
                                    ...
                                    <div class="col-md-10">
                                        <ckeditor :editor="editor"
                                                  v-model="form[locale].about"></ckeditor>
                                    </div>
                                </div>
